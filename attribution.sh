...
# python3 incremental_pred.py --data_path data/seen.all.strided.1024.pdnc.4096.right0.json --use_70b --exp full.incremental.seen.s1024.4096.r0
...
# python3 incremental_pred.py --data_path data/unseen.all.strided.1024.pdnc.4096.right0.json --use_70b --exp incremental.unseen.70.s1024.4096.r0
